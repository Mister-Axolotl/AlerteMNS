        ...
        <div class="channel-content" id="channel-content">
            ...
            <div class="my-account">
                ...
                <div class="profile-picture">
                    ...
                    <form id="submit-picture" action="./public/scripts/updateUserPicture.php" method="post"
            ...
            <div class="faq">
                ...
                <br>
                <h2>Comment voir les personnes qui ont accès au canal</h2>
                <p>Il suffit de cliquer sur le nom du canal en haut au centre de l'écran.</p>
                <br>
                <h2>Comment se déconnecter</h2>
                <p>Il suffit de cliquer sur le bouton "Déconnexion" en bas à gauche</p>
            </div>
            ...
            <div class="rgpd">
                ...
                <p>Nous nous engageons à protéger la confidentialité et la sécurité des données personnelles de nos
                    utilisateurs. Cette politique de protection des données explique comment nous collectons, utilisons,
                    partageons et protégeons vos informations personnelles.</p>
                ...
                <ul>
                    <li><strong>Informations d'inscription</strong> : nom, adresse email, identifiant.</li>
                    <li><strong>Données de profil</strong> : photo de profil, bio, centres d'intérêt.</li>
                    <li><strong>Données d'utilisation</strong> : messages envoyés, interactions avec d'autres
                        utilisateurs, préférences.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Vous envoyer des notifications importantes concernant l'application.</li>
                </ul>
                ...
                <p>Pour exercer ces droits, veuillez nous contacter à l'adresse suivante : <a
                        href="mailto:contact@example.com">contact@example.com</a>.</p>

                <h2>7. Durée de Conservation des Données</h2>
                <p>Nous conservons vos données personnelles aussi longtemps que nécessaire pour vous fournir nos
                    services et pour se conformer à nos obligations légales.</p>

                <h2>8. Modifications de la Politique de Confidentialité</h2>
                <p>Nous pouvons mettre à jour cette politique de protection des données de temps à autre. Nous vous
                    informerons de toute modification en publiant la nouvelle politique sur notre application.</p>

                <h2>9. Contact</h2>
                <p>Si vous avez des questions concernant cette politique de protection des données, veuillez nous
                    contacter à <a href="mailto:contact@example.com">contact@example.com</a>.</p>
            </div>
        </div>
    </div>
</body>
