		...
		<div class="container">
			...
			<div class="left-container" id="left-container">
				...
				<div class="channels">
					<div class="channel public-channel">
						...
						<img src="./images/channel/newspaper.png" alt="Actualités icône">
			...
			<div class="right-container" id="right-container">
				...
				<div class="message-container">
					<!-- OTHER USERS BUBBLE DESIGN -->
					<div class="others-message">
						<img class="user-profile-picture" src="./images/profile-user.png"
					...
					<div class="others-message">
						...
						<div class="message">
							...
							<p class="content">
								...
								consectetur adipisicing elit. Itaque omnis ex corporis quidem, voluptatum culpa sed,
								consectetur, nobis accusantium vel corrupti! Facere beatae vero placeat tempore, neque
								vel excepturi nostrum? Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga
								alias explicabo enim praesentium repudiandae est eveniet qui beatae ab, ut voluptates
								vero assumenda quas adipisci distinctio iure non libero sit. Lorem ipsum, dolor sit amet
								consectetur adipisicing elit. Voluptatum repellat ea debitis reprehenderit architecto
								fugiat facere aliquam quibusdam. Odio asperiores dolorum porro nesciunt sit eveniet
								voluptas excepturi et mollitia accusantium. Lorem ipsum dolor, sit amet consectetur
								adipisicing elit. Optio voluptas neque recusandae a doloribus accusantium alias
								accusamus magni aliquid, cupiditate fugit perferendis similique placeat asperiores
								minima iste quo, ad enim?
							</p>
						</div>
					</div>
					<!-- USER SESSION BUBBLE DESIGN -->
					<div class="my-message">
						<img src="./images/profile-user.png" class="user-profile-picture"
							alt="Image de profil utilisateur">
						<div class="message">
							<div class="info">
								<p class="date">Date</p>
							...
							<p class="content">
								Lorem ipsum dolor. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam
								veniam minus, facilis accusamus itaque ratione quod magni assumenda aliquam excepturi
								voluptates temporibus corrupti quae expedita consectetur. Eum quae maiores itaque!
							</p>
						</div>
					</div>
				</div>
